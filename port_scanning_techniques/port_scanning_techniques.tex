...
In this chapter, we present the results of several experiments that were conducted to estimate the most effective browser-based port scanning strategy for each combination of operating system and browser. 
