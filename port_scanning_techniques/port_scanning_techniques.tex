...
The presence of \emph{unsafe} ports~\citetechnical{firefox_restricted_ports,chrome_restricted_ports}, which cannot be reliably classified as open or closed, introduces complexity to port scanning.
