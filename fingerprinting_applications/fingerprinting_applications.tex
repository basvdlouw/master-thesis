...
The browser-based port scanner application as discussed in the previous chapter was used to scan the entire port range (0-65536) for both default installations of Windows and Ubuntu.
