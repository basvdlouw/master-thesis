...
to be defended publicly on Monday December 11, 2023 at 14:00 PM.\@
...
%% Add additional information here, per faculty requirements, e.g
    Student number: & 852361065 \\
    Course code: & IM9906\\
    Thesis committee:
        & dr. ir. Hugo Jonker (chairman), & Open University \\
        & dr. Stefano Shivo (supervisor), & Open University \\
        & Benjamin Krumnow, MSc (external reviewer) & TH K\"oln
\end{tabular}
