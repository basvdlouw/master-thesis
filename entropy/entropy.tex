...
However, not all ports are detectable by a browser, restricted ports~\citetechnical{chrome_restricted_ports,firefox_restricted_ports} are not detectable, which is not a significant amount of ports, but still noteworthy.
